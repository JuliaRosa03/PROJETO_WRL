...
def componentes_frame1(inp_frame,inp_janela, inp_menu):
    ...
    # {=======================Título=========================}
    titulo = fun1.CRIAR_LABEL(inp_frame, "Cadastrar Bico", fundo_branco, verde_escuro, 'arial', '25', 'bold')
    titulo.place(relx=0.3, rely=0.05) 

    # {=======================USINA=========================}
    label_usina = fun1.CRIAR_LABEL(inp_frame, "Usina: ", fundo_branco, marrom, 'arial', '20', 'bold')
...
def componentes_frame2(inp_frame):
    # {=======================Título=========================}
    titulo = fun1.CRIAR_LABEL(inp_frame, "Bicos Registrados", fundo_branco, verde_escuro, 'arial', '25', 'bold')
    titulo.place(relx =0.3, rely=0.05) 
