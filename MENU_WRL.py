...
class APK():
    ...
    def componentes_frame1(self):
        # {=======================Título=========================}
        self.titulo = fun.CRIAR_LABEL(self.frame_1, "Wear Register Lances", '#B4FF9A', "#005200", 'arial', '25', 'bold')
        ...
        self.bt_cadastro_lanca.place(relx=0.55, rely=0.46, relwidth=0.4, relheight=0.2)

        self.bt_cadastro_funcionario = fun.CRIAR_BOTAO(self.frame_1,'Cadastrar Usina','#4EA93B','#005200',3,'32','bold',"hand2")
        self.bt_cadastro_funcionario.place(relx=0.55, rely=0.71, relwidth=0.4, relheight=0.2)

        # {=======================Botões de Visualização=========================}
        # self.bt_visualizar_tabela = fun.CRIAR_BOTAO(self.frame_1,'Ultimos Registros','#258D19','#005200',4,'32','bold',"hand2")
        # self.bt_visualizar_tabela.place(relx=0.55, rely=0.06, relwidth=0.4, relheight=0.2)
        
        self.bt_visualizar_site = fun.CRIAR_BOTAO(self.frame_1,'SITE COF','#4EA93B','#005200',4,'32','bold',"hand2")
        self.bt_visualizar_site.place(relx=0.55, rely=0.21, relwidth=0.4, relheight=0.2)
        ...
        self.bt_iniciar_camera.place(relx=0.07, rely=0.46, relwidth=0.4, relheight=0.45)
