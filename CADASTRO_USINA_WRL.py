...
def componentes_frame1(inp_frame,inp_janela, inp_menu):
    # {=======================Títulos=========================}
    titulo_1 = fun1.CRIAR_LABEL(inp_frame, "Cadastrar Usina", fundo_branco, verde_escuro, 'arial', '25', 'bold')
    titulo_1.place(relx=0.15, rely=0.05) 
    
    titulo_2 = fun1.CRIAR_LABEL(inp_frame, "Primeiro Registro\nda nova Usina", fundo_branco, verde_escuro, 'arial', '25', 'bold')
    titulo_2.place(relx =0.65, rely=0.05)

    # {=======================USINA - PAÍS=========================}
    label_usina_pais = fun1.CRIAR_LABEL(inp_frame, "País: ", fundo_branco, marrom, 'arial', '20', 'bold')
    ...
    # {=======================USINA - ESTADO=========================}
    label_usina_estado = fun1.CRIAR_LABEL(inp_frame, "Estado: ", fundo_branco, marrom, 'arial', '20', 'bold')
    ...
    # {=======================USINA - NOME=========================}
    label_usina_nome = fun1.CRIAR_LABEL(inp_frame, "Usina: ", fundo_branco, marrom, 'arial', '20', 'bold')
    ...
    bt_voltar = fun1.CRIAR_BOTAO(inp_frame, "VOLTAR",verde, bege,3,'15','bold',"hand2",lambda: fun1.BOTAO_VOLTAR( inp_menu, inp_janela))
    ...
    bt_continuar = fun1.CRIAR_BOTAO(inp_frame, "SALVAR",verde, bege,3,'15','bold',"hand2", lambda: salvar(inp_menu, inp_janela))#,
